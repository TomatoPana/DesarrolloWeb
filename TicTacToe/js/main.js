function loadgame(){
  $.ajax({
    url: "http://localhost/DesarrolloWeb/TicTacToe/Control.php?action=1"
  }).done(function(data) {
    $("#game").html(data.response);
    ...
    function checkGameStatus() {
      if (
        (gameStatus[0][0] != null &&
          gameStatus[0][1] != null &&
          gameStatus[0][2] != null &&
          (gameStatus[0][0] === gameStatus[0][1] &&
            gameStatus[0][1] === gameStatus[0][2])) ||
        (gameStatus[1][0] != null &&
          gameStatus[1][1] != null &&
          gameStatus[1][2] != null &&
          (gameStatus[1][0] === gameStatus[1][1] &&
            gameStatus[1][1] === gameStatus[1][2])) ||
        (gameStatus[2][0] != null &&
          gameStatus[2][1] != null &&
          gameStatus[2][2] != null &&
          (gameStatus[2][0] === gameStatus[2][1] &&
            gameStatus[2][1] === gameStatus[2][2])) ||
        (gameStatus[0][0] != null &&
          gameStatus[1][0] != null &&
          gameStatus[2][0] != null &&
          (gameStatus[0][0] === gameStatus[1][0] &&
            gameStatus[1][0] === gameStatus[2][0])) ||
        (gameStatus[0][1] != null &&
          gameStatus[1][1] != null &&
          gameStatus[2][1] != null &&
          (gameStatus[0][1] === gameStatus[1][1] &&
            gameStatus[1][1] === gameStatus[2][1])) ||
        (gameStatus[0][2] != null &&
          gameStatus[1][2] != null &&
          gameStatus[2][2] != null &&
          (gameStatus[0][2] === gameStatus[1][2] &&
            gameStatus[1][2] === gameStatus[2][2])) ||
        (gameStatus[0][0] != null &&
          gameStatus[1][1] != null &&
          gameStatus[2][2] != null &&
...
function showChart() {
  $.ajax({
    url: "http://localhost/DesarrolloWeb/TicTacToe/Control.php?action=3&data=0,1,2,2,0"
  }).done(function(data) {
    var ctx = document.getElementById("stadistics");
